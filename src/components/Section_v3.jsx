export default function Section_v3() {
  return (
    <>
      <div className="container relative flex flex-col justify-between h-full max-w-6xl px-10 mx-auto xl:px-0 mt-5 py-14">
      <div className="absolute -top-10" id="services"></div>
        ...
        <div className="w-full">
          <div className="flex flex-col w-full mb-10 sm:flex-row ">
            <div className="w-full mb-10 sm:mb-0 sm:w-1/2 hover:scale-110 duration-300">
            ...
            <div className="w-full sm:w-1/2 hover:scale-110 duration-300">
            ...
            <div className="w-full sm:w-1/2 hover:scale-110 duration-300">
              <div className="relative h-full ml-0 md:mr-10">
                ...
                <div className="relative h-full p-5 bg-white border-2 border-green-500 rounded-lg">
                  ...
                  <p className="mb-2 text-gray-600">
                    Bot development frameworks were created as advanced software tools
                    that eliminate a large amount of manual work and accelerate the
                    development process.
                  </p>
                </div>
              </div>
